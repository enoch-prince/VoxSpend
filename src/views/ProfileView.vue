  ...
  <div class="profile-view overflow-y-auto h-full">
    <div class="profile-view__content px-lg py-md">
      ...
      <div class="neo-card-sm mb-md">
        <div class="profile-view__row" @click="themeStore.toggleMode">
          ...
          <div
            ...
            :class="{ 'profile-view__toggle--on': themeStore.mode === 'dark' }"
          >
        ...
        <div
          class="profile-view__row"
          @click="toggleNotifications"
          :style="{ opacity: notificationToggling ? 0.7 : 1 }"
        >
          ...
          <div
            class="profile-view__toggle"
            :class="{ 'profile-view__toggle--on': optimisticNotificationsEnabled }"
          >
            <div class="profile-view__toggle-knob"></div>
          </div>
        </div>
      ...
      <div v-if="showApiKey" class="neo-card mb-md">
        <label class="text-xs text-secondary font-medium mb-xs" style="display: block"
          >Groq API Key</label
        >
        <input
          v-model="apiKeyInput"
      ...
      <div v-if="showCategories" class="neo-card mb-md">
        <div class="flex flex-col gap-sm mb-md">
          ...
          >
            ...
            <span class="material-symbols-rounded icon-sm" :style="{ color: cat.color }">{{
              cat.icon
            }}</span>
      ...
      <div class="profile-view__footer">
        ...
        <p class="text-xs text-tertiary">
          Made with ❤️ by
          <a href="https://github.com/enoch-prince" target="_blank">Enoch Prince</a>😎
        </p>
      </div>
