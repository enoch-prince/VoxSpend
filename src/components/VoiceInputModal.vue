  ...
  <transition name="modal">
    <div v-if="voiceStore.state !== 'idle'" class="voice-modal" @click.self="voiceStore.cancel">
      <div class="voice-modal__content modal-content neo-card">
        ...
        <!-- Confirm State -->
        <div
          v-else-if="voiceStore.state === 'confirm' && voiceStore.parsedExpenses?.length > 0"
          class="voice-modal__confirm"
        >
                  ...
                  <div class="voice-modal__detail-item">
                    ...
                    <input
                      ...
                      @input="
                        (e) =>
                          voiceStore.updateParsed(index, {
                            merchant: (e.target as HTMLInputElement).value,
                          })
                      "
                      class="neo-input"
                  ...
                  <div class="voice-modal__detail-item">
                    ...
                    <select
                      ...
                      @change="
                        (e) =>
                          voiceStore.updateParsed(index, {
                            type: (e.target as HTMLSelectElement).value as 'expense' | 'income',
                          })
                      "
                      class="neo-input"
                    >
...
<style lang="scss">
  ...
  @keyframes pulse-glow {
    ...
    50% {
      box-shadow: 0 0 20px 8px rgba($danger, 0.15);
    }
  }
